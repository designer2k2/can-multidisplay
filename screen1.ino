...
void screen1run() {
  ...
  tft.print("TMP75 C: = ");
  tft.print(lm75temp);
  tft.print(F(" MPU C: ")); tft.print(mpu.getTemp());
  tft.print(F(" Teensy C: ")); tft.println(tempmonGetTemp());
  ...
  tft.setCursor(1, 20);
  tft.print(F("TEMPERATURE: ")); tft.println(mpu.getTemp());
  char sz[32];
  ...
  tft.print(F("ACC ANGLE X: ")); tft.print(mpu.getAccAngleX());
  tft.print("  Y: "); tft.println(mpu.getAccAngleY());

  tft.print(F("ANGLE     X: ")); tft.print(mpu.getAngleX());
  tft.print("  Y: "); tft.print(mpu.getAngleY());
  tft.print("  Z: "); tft.println(mpu.getAngleZ());

  tft.println("");

  tft.print("Analog0: "); tft.print(val_0);
  tft.print(" Analog1: "); tft.println(val_1);
  tft.print("Analog2: "); tft.print(val_2);
  tft.print(" Analog3: "); tft.println(val_3);
  tft.print("ADS Error: "); tft.println(ADS.getError());
  ...
  //GPS:
  tft.print("GPS: ");
  tft.print("char: "); tft.print(gps.charsProcessed());
  tft.print(" sntn: "); tft.print(gps.sentencesWithFix());
  tft.print(" fail: "); tft.print(gps.failedChecksum());
  tft.print(" valid: "); tft.println(gps.satellites.isValid());
  tft.print("sat: "); tft.print(gps.satellites.value());
  tft.print(" hdop: "); tft.print(gps.hdop.hdop());
  tft.print(" age: "); tft.print(gps.location.age());
  tft.print(" course: "); tft.println(gps.course.deg());
  tft.print("lat: "); tft.print(gps.location.lat(), 4);
  tft.print(" lon: "); tft.print(gps.location.lng(), 4);
  tft.print(" height: "); tft.print(gps.altitude.meters());
  tft.print(" speed: "); tft.println(gps.speed.kmph());
  ...
  tft.print("EMU RPM: "); tft.println(emucan.emu_data.RPM);
